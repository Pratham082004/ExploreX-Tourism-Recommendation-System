...
class FeatureEngineer:
    """Create engineered features for the domestic recommendation model.

    The domestic pipeline starts with a cleaned dataset.
    ...
    def get_budget_category(cost: float) -> str:
        """Categorize a package into a budget bucket."""
    ...
    def get_duration_category(days: int) -> str:
        """Categorize a package into a duration bucket."""
    ...
    def create_package_profile(self):
        """Build the weighted `package_profile` text field."""
    ...
    def save_dataset(self):
        """Save the engineered training dataset to disk."""
