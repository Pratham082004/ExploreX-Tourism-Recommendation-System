        ...
        <div className="about-container">
            ...
            <div className="about-card mb-16">
                <div className="flex flex-col md:flex-row gap-10 items-center">
                    ...
                    <div className="w-full md:w-1/2 bg-slate-50 rounded-3xl h-72 flex items-center justify-center overflow-hidden border border-slate-100 relative">
                        {/* Placeholder pattern */}
                        <div className="absolute inset-0 opacity-20" style={{backgroundImage: 'radial-gradient(#ec4899 2px, transparent 2px)', backgroundSize: '24px 24px'}}></div>
                        <div className="relative z-10 w-24 h-24 bg-white rounded-full flex items-center justify-center shadow-xl shadow-pink-500/20">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-pink-500"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="mb-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {[
                        ...
                        { title: "Detailed Itineraries", icon: "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z", color: "blue", desc: "Day-by-day guides so you never miss a thing." },
